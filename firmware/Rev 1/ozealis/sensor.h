...
// VIN monitor divider
#define VIN_SEN 35
#define VIN_DIVIDER_RATIO 11.0f  // ensure float precision (matches .cpp math)
...
float vinFiltered();                            // low-pass filtered VIN (τ≈300 ms)
float getPressureDiff();                        // ΔP = blower – mask (hPa)
